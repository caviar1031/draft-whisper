...
pub fn run() {
    let app = tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            tts::tts_test,
            audio::tts_read_audio,
            audio::tts_delete_audio_files,
            native_file::tts_copy_to_clipboard,
            native_file::tts_show_in_finder,
            native_file::tts_drag_file,
            projects::tts_list_projects,
            projects::tts_create_project,
            projects::tts_delete_project,
            audio::save_voice_sample,
            audio::delete_voice_sample,
            credentials::save_api_key,
            credentials::load_api_key,
            credentials::delete_api_key,
            credentials::migrate_legacy_api_key,
        ])
